...
const Sidebar = () => {
    ...
    return (
        <motion.aside
            ...
            initial="hidden"
            animate="visible"
            className="hidden lg:flex fixed top-23 left-18 h-[calc(100vh-200px)] w-70 bg-bg-sidebar border-2 border-border rounded-2xl flex-col items-center justify-between py-10 px-6 z-50"
        >
