...
const Sidebar = () => {
    ...
    return (
        <aside className="fixed top-6 left-6 h-[calc(100vh-48px)] w-70 bg-bg-sidebar border-2 border-border rounded-2xl flex flex-col items-center justify-between py-10 px-6 z-50">
