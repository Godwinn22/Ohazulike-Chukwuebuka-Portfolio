export const myData = {
    ...
    social: {
        github: "https://github.com/godwinn22",
        twitter: "https://x.com/Pandas_Stack",
        linkedin: "https://www.linkedin.com/in/ohazulike-godwin",
    },
};
...
export const statsData = [
    ...
    { number: "+5", label: "HAPPY\nCLIENTS" },
];

export const projectsData = [
    {
        id: 1,
        title: "Asset Pulse HQ",
        slug: "asset-pulse",
        category: "Asset Tracker Dashboard",
        description:
        ...
        githubUrl: "https://github.com/Godwinn22/AssetPulse",
        year: "2026",
    },
    {
        id: 2,
        title: "Setime Digital Hub",
        slug: "setime-digital-hub",
    ...
    {
        id: 3,
        title: "JovitaChi Foundation",
        slug: "jovitachi-foundation",
    ...
    {
        id: 4,
        title: "Supreme Package Machinery",
        slug: "supreme-package-machinery",
        category: "Industrial Machinery Website",
        description:
    ...
    {
        id: 5,
        title: "Vermac Educational Foundation",
        slug: "vermac-educational-foundation",
        category: "NGO Foundation Website",
        description:
...
export const toolsData = [
    {
        ...
        name: "React",
        category: "Frontend",
        description: "My primary framework for building user interfaces.",
        icon: "SiReact",
        color: "#61DAFB",
    },
    {
        ...
        name: "Django",
        category: "Backend",
        description: "My primary framework for building web applications.",
        icon: "SiDjango",
        color: "#092E20",
    },
    {
        ...
        name: "Vite",
        category: "Build Tool",
        description: "My preferred build tool for fast development.",
        icon: "SiVite",
        color: "#646CFF",
    },
    {
        ...
        description: "I use Git for version control and collaboration.",
        icon: "SiGit",
        color: "#F05032",
    },
    {
        ...
        name: "Figma",
        category: "Design",
        description: "I use Figma for UI/UX design and prototyping.",
        icon: "SiFigma",
        color: "#F24E1E",
    },
    {
        ...
        name: "Tailwind CSS",
        category: "Styling",
        description: "My go-to for styling — fast, consistent and clean.",
        icon: "SiTailwindcss",
        color: "#06B6D4",
    },
    {
        ...
        name: "Supabase",
        category: "Backend",
        description: "My preferred backend solution for scalable apps.",
        icon: "SiSupabase",
        color: "#3ECF8E",
    },
    {
        ...
        name: "WordPress",
        category: "CMS",
        description: "I use WordPress for building dynamic websites.",
        icon: "SiWordpress",
        color: "#21759B",
    },
];
